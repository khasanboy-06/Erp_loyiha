...
from .views import LoginView, RegisterView, Profile, EditProfileView, LogoutView, GroupView, StudentListView, EditStudentView, DeleteStudentView, StudentByTeamView, ResetPasswordView, AdminDashboardView
